...
export namespace Prisma {
  ...
  */
  ...
  export type IndustryInsightCountOutputTypeSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    user?: boolean | IndustryInsightCountOutputTypeCountUserArgs
  }
   ...
   * IndustryInsightCountOutputType without action
   */
  export type IndustryInsightCountOutputTypeCountUserArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
  ...
  export type IndustryInsightSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    lastUpdated?: boolean
    nextUpdate?: boolean
    user?: boolean | IndustryInsight$userArgs<ExtArgs>
  ...
  export interface Prisma__IndustryInsightClient<T, Null = never, ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise"
    user<T extends IndustryInsight$userArgs<ExtArgs> = {}>(args?: Subset<T, IndustryInsight$userArgs<ExtArgs>>): Prisma.PrismaPromise<$Result.GetResult<Prisma.$UserPayload<ExtArgs>, T, "findMany", GlobalOmitOptions> | Null>
    /**
     * Attaches callbacks for the resolution and/or rejection of the Promise.
     * @param onfulfilled The callback to execute when the Promise is resolved.
     * @param onrejected The callback to execute when the Promise is rejected.
   ...
   */
  export type IndustryInsight$userArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * Select specific fields to fetch from the User
     */
    select?: UserSelect<ExtArgs> | null
  ...
  export type UserCreateInput = {
    ...
    IndustryInsight?: IndustryInsightCreateNestedOneWithoutUserInput
  ...
  export type UserUpdateInput = {
    ...
    IndustryInsight?: IndustryInsightUpdateOneWithoutUserNestedInput
  ...
  export type IndustryInsightCreateInput = {
    ...
    user?: UserCreateNestedManyWithoutIndustryInsightInput
  }
  ...
  export type IndustryInsightUncheckedCreateInput = {
    ...
    lastUpdated?: Date | string
    nextUpdate: Date | string
    user?: UserUncheckedCreateNestedManyWithoutIndustryInsightInput
  }
  ...
  export type IndustryInsightUpdateInput = {
    ...
    user?: UserUpdateManyWithoutIndustryInsightNestedInput
  }
  ...
  export type IndustryInsightUncheckedUpdateInput = {
    ...
    lastUpdated?: DateTimeFieldUpdateOperationsInput | Date | string
    nextUpdate?: DateTimeFieldUpdateOperationsInput | Date | string
    user?: UserUncheckedUpdateManyWithoutIndustryInsightNestedInput
  }
  ...
  export type IndustryInsightCreateNestedOneWithoutUserInput = {
    create?: XOR<IndustryInsightCreateWithoutUserInput, IndustryInsightUncheckedCreateWithoutUserInput>
    connectOrCreate?: IndustryInsightCreateOrConnectWithoutUserInput
  ...
  export type IndustryInsightUpdateOneWithoutUserNestedInput = {
    create?: XOR<IndustryInsightCreateWithoutUserInput, IndustryInsightUncheckedCreateWithoutUserInput>
    connectOrCreate?: IndustryInsightCreateOrConnectWithoutUserInput
    upsert?: IndustryInsightUpsertWithoutUserInput
    disconnect?: IndustryInsightWhereInput | boolean
    delete?: IndustryInsightWhereInput | boolean
    connect?: IndustryInsightWhereUniqueInput
    update?: XOR<XOR<IndustryInsightUpdateToOneWithWhereWithoutUserInput, IndustryInsightUpdateWithoutUserInput>, IndustryInsightUncheckedUpdateWithoutUserInput>
  }
  ...
  export type IndustryInsightCreateWithoutUserInput = {
    id?: string
    industry: string
    salaryRanges?: IndustryInsightCreatesalaryRangesInput | InputJsonValue[]
    growthRate: number
  ...
  export type IndustryInsightUncheckedCreateWithoutUserInput = {
    id?: string
    industry: string
    salaryRanges?: IndustryInsightCreatesalaryRangesInput | InputJsonValue[]
    growthRate: number
  ...
  export type IndustryInsightCreateOrConnectWithoutUserInput = {
    where: IndustryInsightWhereUniqueInput
    create: XOR<IndustryInsightCreateWithoutUserInput, IndustryInsightUncheckedCreateWithoutUserInput>
  }
  ...
  export type IndustryInsightUpsertWithoutUserInput = {
    update: XOR<IndustryInsightUpdateWithoutUserInput, IndustryInsightUncheckedUpdateWithoutUserInput>
    create: XOR<IndustryInsightCreateWithoutUserInput, IndustryInsightUncheckedCreateWithoutUserInput>
    where?: IndustryInsightWhereInput
  }

  export type IndustryInsightUpdateToOneWithWhereWithoutUserInput = {
    where?: IndustryInsightWhereInput
    data: XOR<IndustryInsightUpdateWithoutUserInput, IndustryInsightUncheckedUpdateWithoutUserInput>
  }

  export type IndustryInsightUpdateWithoutUserInput = {
    id?: StringFieldUpdateOperationsInput | string
    industry?: StringFieldUpdateOperationsInput | string
    salaryRanges?: IndustryInsightUpdatesalaryRangesInput | InputJsonValue[]
    growthRate?: FloatFieldUpdateOperationsInput | number
  ...
  export type IndustryInsightUncheckedUpdateWithoutUserInput = {
    id?: StringFieldUpdateOperationsInput | string
    industry?: StringFieldUpdateOperationsInput | string
    salaryRanges?: IndustryInsightUpdatesalaryRangesInput | InputJsonValue[]
    growthRate?: FloatFieldUpdateOperationsInput | number
